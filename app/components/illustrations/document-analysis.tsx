...
export const DocumentAnalysisIllustration = () => {
    return (
        <div
            aria-hidden
            className="bg-foreground/3 relative isolate flex min-h-36 items-center justify-center rounded p-6">
            ...
            <div
                aria-hidden
                className="bg-card shadow-black/6.5 w-20 space-y-2 rounded-md p-3 shadow-lg">
